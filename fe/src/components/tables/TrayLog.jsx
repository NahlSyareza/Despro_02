        ...
        <table className="w-full text-sm">
          <thead className="border-b border-t">
            <tr className="border-b border-border">
              <th className="text-center py-2 font-semibold text-gray-500">
                Date
              </th>
              <th className="text-center py-2 font-semibold text-gray-500">
                Tray ID
            ...
            {currentLogs.map((log, idx) => (
              ...
              >
                ...
                <td className="py-3 text-center">
                  <a
                    href="#"
                    className="text-purple-500 bg-purple-100 rounded-xl px-2 py-0.5 hover:underline"
                  >
                    See Image
                  </a>
                </td>
