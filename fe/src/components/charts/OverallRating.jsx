...
export function OverallRating({ data }) {
  console.log("Overall Rating data: ", data);
  const legendPayload = [
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Summarizes the overall rating trends collected from student feedback
          to track changes in meal satisfaction over time.
        </CardDescription>
      </CardHeader>
      <CardContent>
